...
namespace dwalesskaAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dwalesskaAPI", Version = "v1" });
            });
            ...
            //string SendGridEmail = Configuration["SendGridEmail"];
            services.AddSingleton<string>(RecaptchaKey);
            //services.AddSingleton<string>(SendGridAPI);
            //services.AddSingleton<string>(SendGridEmail);
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {                
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "dwalesskaAPI v1"));
            }
